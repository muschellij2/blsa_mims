...
masterfile_path <- paste0(here::here(), "/data_processed/2021-03-25-measures_masterfile_winsorized.rds")
masterfile <- readRDS(masterfile_path) %>% as.data.frame()
dim(masterfile)
# [1] 5566920      12

# masterfile_uw_path <- paste0(here::here(), "/data_processed/2021-03-25-measures_masterfile.rds")
