...
measures_masterfile_fpath <- paste0(here::here(), "/data_processed/2021-04-13-measures_masterfile_winsorized_imp_mapped.rds")
...
measures_masterfile_fpath <- paste0(here::here(), "/data_processed/2021-03-25-measures_masterfile.rds")
measures_masterfile <- readRDS(measures_masterfile_fpath)
nrow(measures_masterfile)
# [1] 5566920
length(unique(measures_masterfile$subj_id))
...
measures_masterfile_fpath <- paste0(here::here(), "/data_processed/2021-04-01-measures_masterfile_winsorized_imp.rds")
measures_masterfile <- readRDS(measures_masterfile_fpath)
nrow(measures_masterfile)
# [1] 5567040
length(unique(measures_masterfile$subj_id))
