...
length(mod_ENMO_AC$coefficients)
length(mod_MAD_AC$coefficients)
length(mod_AI_AC$coefficients)

mod_MIMS_AC <- gam(MIMS ~ s(AC, bs = "tp"), data = dat_acc)
mod_MIMS_AC$coefficients
