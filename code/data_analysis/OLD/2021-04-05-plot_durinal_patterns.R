...
for (i in 1 : length(name_levels)){ # i <- 1
  ...
  plt_i <- 
    ...
    geom_line(data = plt_df_L_i, aes(x = minute_label, y = value, color = age_cat, group = age_cat), size = 1)
  plt_i
...
plt_path <- paste0(here::here(), "/results_figures/2021-04-05-replicate_physicalcliff_median_smoothed.png")
