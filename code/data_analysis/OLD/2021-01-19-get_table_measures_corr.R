...
#' 
#' To download the file locally, use: 
#' get /dcl01/smart/data/activity/blsa_mims/results/2021-01-19-correlations_between_measures.rds /Users/martakaras/Dropbox/_PROJECTS/blsa_mims/results/2021-01-19-correlations_between_measures.rds 
...
datacc_fpath <- paste0(here::here(), "/results/2021-01-19-correlations_between_measures.rds")
...
# save data to file 
fpath_tmp <- paste0(here::here(), "/results/2021-01-21-table_measures_corr.csv")
