...
# 6  AC_MIMS 0.02771649         6            1
# 11 AC_ENMO 0.04576463         2            1
# 24  AC_MAD 0.03475264         6            1
# 29   AC_AI 0.04224196         2            1
...
for (i in 1:4){ # i <- 3
  ...
  y_lab_tmp <- var_names[i]
  dat$y     <- dat[, y_lab_tmp]
  # transform the outcome from rho to z-score values
  dat$y     <- rho_to_z(dat$y)
