...
plt_path <- paste0(here::here(), "/results_figures/2021-04-13-measures_corr_model_age_effect_twosmooths.png")
...
plt_path <- paste0(here::here(), "/results_figures/2021-04-13-measures_corr_model_bmi_effect_twosmooths.png")
ggsave(filename = plt_path, plot = plt, width = 8, height = 6.5) 
