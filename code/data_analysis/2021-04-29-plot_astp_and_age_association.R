...
path_tmp <- paste0(here::here(), "/results/2021-04-29-astp_and_age_association.rds")
...
plt_path <- paste0(here::here(), "/results_figures/2021-04-29-activeprop_TP_comparison_across_metrics.png")
...
plt_path <- paste0(here::here(), "/results_figures/2021-04-29-astp_and_age_association.png")
...
plt_path <- paste0(here::here(), "/results_figures/2021-04-29-cases_ASTP_AC_MIMS.png")
